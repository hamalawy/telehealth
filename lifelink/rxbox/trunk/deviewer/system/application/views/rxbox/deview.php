...
<head>
<title>Domain Expert's Window</title>
<script language="javascript" type="text/javascript" src="js/flot/jquery.js"></script>
<script language="javascript" type="text/javascript" src="js/flot/jquery.flot.js"></script>
<script language="javascript" type="text/javascript" src="js/rxboxplotstat.js"></script>
<link rel="stylesheet" type="text/css" href="css/triageviewer.css"></style>
</head>
<body>
<center>
...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <script type="text/javascript" src="<?php echo base_url() ?>public/js/jsjac-1.3.2/jsjac.js"></script>
    <!-- comment in above and uncomment below if you want to modify/hack
         on jsjac -->
    <!--script type="text/javascript" src="http://<?php echo base_url() ?>/public/js/jsjac-1.3.2/jsjac.js"></script-->
