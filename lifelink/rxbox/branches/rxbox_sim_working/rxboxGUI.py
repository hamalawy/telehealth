...
class DAQPanel(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.button_separator = wx.StaticLine(self, -1, style=wx.LI_VERTICAL)
        ...
        self.bpmvalue_label = wx.StaticText(self, -1, "00", style=wx.ALIGN_CENTRE)
        ...
        self.spo2value_label = wx.StaticText(self, -1, "00", style=wx.ALIGN_CENTRE)
    ...
    def __set_properties(self):
        ...
        self.Refer_Button.SetToolTipString("Stop data acquisition from the biomedical modules")
    ...
    def __do_layout(self):
        ...
        now_button_sizer = wx.BoxSizer(wx.HORIZONTAL)
        ...
        buttons_sizer.Add(self.button_separator, 0, wx.ALL|wx.EXPAND, 4)
        buttons_sizer.Add(self.Refer_Button, 0, wx.ALL, 4)
        buttons_sizer.Add(self.Refer_Label, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        ...
        now_button_sizer.Add(self.bpNow_Button, 1, wx.LEFT|wx.TOP|wx.BOTTOM|wx.EXPAND, 4)
        bp_sizer.Add(self.bp_label, 0, wx.BOTTOM|wx.EXPAND, 1)
        bp_sizer.Add(self.bpvalue_label, 0, wx.EXPAND, 0)
        bp_sizer.Add(self.bpunit_label, 0, wx.EXPAND, 0)
        now_button_sizer.Add(bp_sizer, 4, wx.RIGHT|wx.TOP|wx.BOTTOM|wx.EXPAND, 4)
        lowerdata_horizontal_sizer.Add(now_button_sizer, 1, wx.EXPAND, 0)
        heartrate_sizer.Add(self.bpm_label, 0, wx.BOTTOM|wx.EXPAND, 1)
        heartrate_sizer.Add(self.bpmvalue_label, 0, wx.EXPAND, 0)
        ...
        spo2_sizer.Add(self.spo2_label, 0, wx.BOTTOM|wx.EXPAND, 1)
        spo2_sizer.Add(self.spo2value_label, 0, wx.EXPAND, 0)
        spo2_sizer.Add(self.bpmunit_label_copy, 0, wx.EXPAND, 0)
