...
"""
    ...
    def firmware(self):
        ...
        if (packet[2]== chr(0x50)) and (packet[3]== chr(0x1)):
            ...
            #self.firmware_string = "%s%s%s%s%s%s%s%s%s%s%s" % tuple(packet[4:15])
    ...
    def selftest(self):
        ...
        if (packet[2]== chr(0x0)) and (packet[3]== chr(0x6)) and\
           ...
           (ord(packet[4]) & 64 !=64):
            print "int_FLASH Test Failed!"
            
        elif (packet[2]== chr(0x0)) and (packet[3]== chr(0x6)) and\
           (ord(packet[4]) & 32 !=32):
            print "PLD/ADC Test Failed!"
    ...
    def device_ready(self):
        ...
        self.protocol()
        self.selftest()
        if ((self.device_ready_counter%4)!=0) or (self.device_ready_counter==0):
            print "\n--->>ECG IS NOT READY!"
        else:
            print "\n--->>ECG IS NOW READY!"
            #self.patient_ready()
...
##                elif lead =='III':
##                    self.leadIII_values.append(ecg_reading) # add ecg lead III reading immediately to "dynamic list" 
##                    self.ecg_leadIII.append(ecg_reading * 0.00263)
    ...
    def protocol(self):
        ...
        if (packet[2]== chr(0x0)) and (packet[3]== chr(0x1)):
            ...
            self.device_ready_counter+=1
        else: print "Unknown Protocol Version"
