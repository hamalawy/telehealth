...
class DAQPanel(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.spo2_label = wx.StaticText(self.spo2_panel1, -1, "Blood Oxygen\nSaturation", style=wx.ALIGN_CENTRE)
    ...
    def __set_properties(self):
        ...
        self.bp_panel1.SetMinSize((113, 108))
    ...
    def __do_layout(self):
        ...
        self.bp_panel1.SetSizer(bp_sizer)
        lowerdata_horizontal_sizer.Add(self.bp_panel1, 2, wx.EXPAND, 0)
        ...
        self.heartrate_panel1.SetSizer(heartrate_sizer)
        lowerdata_horizontal_sizer.Add(self.heartrate_panel1, 2, wx.EXPAND, 0)
        ...
        lowerdata_horizontal_sizer.Add(self.spo2_panel1, 2, wx.EXPAND, 0)
