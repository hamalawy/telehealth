...
class DAQPanel(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.setBPmins_combobox = wx.ComboBox(self.bp_panel, -1, choices=["5 min", "15 min", "30 min", "60 min"], style=wx.CB_DROPDOWN|wx.CB_DROPDOWN)
    ...
    def __do_layout(self):
        ...
        nowButton_horizontal_sizer2 = wx.BoxSizer(wx.HORIZONTAL)
        ...
        #self.bp_panel.SetSizer(self.nowButton_vertical_sizer)
        #bp_grid.Add(self.bp_slider, 1, 0)
        #bp_grid.Add(self.bp_pressure_indicator, 1, 0)
        ...
        #self.nowButton_horizontal_sizer.Add(self.bp_grid, 1, wx.EXPAND, 0)        
