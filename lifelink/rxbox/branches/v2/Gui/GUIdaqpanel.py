...
class DAQPanel(wx.Panel):
    ...
    def __do_layout(self):
        ...
        self.ecg_vertical_sizer3 = wx.BoxSizer(wx.VERTICAL)
        ...
        self.ecg_vertical_sizer3.Add(ecg_horizontal_sizer, 4, wx.EXPAND, 0)
        self.ecg_vertical_sizer3.Add(self.ecg_lowerdata_separator, 0, wx.EXPAND, 0)
        ...
        self.ecg_vertical_sizer3.Add(biomodule_vertical_sizer, 1, wx.EXPAND, 0)
        ecg_biomodule_horizontal_sizer.Add(self.ecg_vertical_sizer3, 1, wx.EXPAND, 0)
