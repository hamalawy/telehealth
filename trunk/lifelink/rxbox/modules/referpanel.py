...
"""
Project LifeLink: referpanel module

Contains the panel for patient-doctor interaction features
such as Video Conferencing, IM, and Photo Snapshot.
...
import wx
# add this for photosnapshot feature in linux
#import opencv
...
class MyPanel(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        #self.camera = Device()
        #self.camera.saveSnapshot("Photos/buffer.jpg")
    ...
    # Enable this function when using the photosnapshot feature in linux
    #def onCapture(self, event):
        ...
        #filename = 'img' + str(self.image_counter) + '.jpg'
        #self.camera.saveSnapshot("Photos/"+filename)
        #raw = wx.Image('Photos/'+filename)
            #raw = wx.Image(filename)
...
class MyDialog(wx.Dialog):
    ...
    def OnCreateRecord(self, event): # wxGlade: MyDialog.<event_handler>
        """ get the supplied patient information and display it in the patient's information static text box """
